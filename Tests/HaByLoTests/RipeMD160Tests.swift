...
@Suite struct RipeMD160Tests {
    ...
    func ripeMD160(_ vector: (message: String, digest: String)) {
        var md = RipeMD160()
        md.update(data: vector.message.ascii[...])
        #expect(md.finalize() == vector.digest.hex2Bytes)
    }
}
